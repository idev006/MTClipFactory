...
- current preset fields such as `headline_pool_names` and `cta_pool_names` are still planner/audit metadata on this baseline; they are not yet a full caption-runtime override path by themselves
