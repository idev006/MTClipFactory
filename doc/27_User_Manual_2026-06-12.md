...
- select one asset first and keep it as the main tagging focus
...
- attach an existing tag to the selected asset
- or click `Create And Attach` to create a new tag and attach it immediately to the selected asset
...
3. Select the asset you want to prepare
4. Review its current tags in the selected-asset panel
