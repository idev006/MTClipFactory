...
4. When script-safe mode is active, grouped `line_advance_ratio` must not compress below `1.0`.
...
- clamp grouped `line_advance_ratio` to at least `1.0`
