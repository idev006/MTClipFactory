...
| ISS-029-CLOSED | 2026-06-12 | Theme Separation Debt | Closed by extracting the settings-window stylesheet into package-backed `ui/themes/settings_window.qss`, adding a reusable `ui.theme` loader/apply seam, updating packaging metadata for `.qss` assets, and adding pytest coverage for theme loading/application. |
