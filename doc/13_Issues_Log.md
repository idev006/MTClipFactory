...
| ISS-018 | 2026-06-06 | Medium | Audio Priority Policy | Audio policy settings and operator-visible composition summaries now exist, but preview/final renderers still do not apply a real mixed audio runtime with duck gain automation. | Engineering | Open | Implement runtime narration/music mixing that consumes the configured duck policy and produces inspectable applied-audio evidence. |
