...
- Recipe Builder now explains its recipe-to-final purpose more directly, clarifies that the attach list shows only `ready` assets, and keeps the asset panel tall enough for practical scanning
