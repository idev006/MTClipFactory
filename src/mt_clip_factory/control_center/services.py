...
class SystemSettingsService:
    ...
    def load(self) -> SystemSettingsDTO:
        ...
        return SystemSettingsDTO(
            ...
            voice_mix_gain_db=int(audio.get("voice_mix_gain_db", 0)),
            music_mix_gain_db=int(audio.get("music_mix_gain_db", -4)),
    ...
    def save(self, settings: SystemSettingsDTO) -> None:
        ...
        content = "\n".join(
            [
                ...
                f"voice_mix_gain_db = {settings.voice_mix_gain_db}",
                f"music_mix_gain_db = {settings.music_mix_gain_db}",
                "",
                "[review]",
